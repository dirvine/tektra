...
from tektra.agents.runtime import AgentRuntime, AgentExecutionContext, SandboxType
from tektra.agents.builder import AgentSpecification, AgentType
from tektra.memory import TektraMemoryManager, MemoryConfig, MemoryType
...
"""
            ...
            await memory_manager.add_agent_context(
                agent_id=source_id,
                context="Another piece of knowledge",
                importance=0.7
            )
