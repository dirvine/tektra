...
def test_memos_import():
    ...
    try:
        ...
        # Test basic import
        from memos.mem_os.main import MOS  # noqa: F401

        print("✅ Successfully imported MOS")

        # Test MemCube import
        from memos.mem_cube.general import GeneralMemCube  # noqa: F401
...
def test_memos_basic_functionality():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            (mem_cube_path / "config.json").write_text(
            ...
            GeneralMemCube.init_from_dir(str(mem_cube_path))
