...
class VoiceConversationPipeline:
    ...
    def __init__(
        self,
        service_manager: UnmuteServiceManager | None = None,
        unmute_path: Path | None = None,
        sample_rate: int = 16000,
        chunk_size: int = 1024,
        channels: int = 1,
        on_transcription: Callable | None = None,
        on_response: Callable | None = None,
        on_audio_response: Callable | None = None,
        ...
        self.on_transcription: Callable[[str], None] | None = on_transcription
        self.on_response: Callable[[str], None] | None = on_response
        self.on_audio_playback: Callable[[bytes], None] | None = on_audio_response
        self.on_status_change: Callable | None = on_status_change
        self.on_error: Callable[[Exception], None] | None = None

        # WebSocket client
        self.ws_client: UnmuteWebSocketClient | None = None
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            if (
                ...
                and not await self.service_manager.are_services_healthy()
            ):
    ...
    async def process_text_input(self, text: str) -> str | None:
        """
